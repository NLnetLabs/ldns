...
enum ldns_enum_status {
	...
	LDNS_STATUS_DNSSEC_CLOSEST_ENCLOSER_NOT_FOUND,
	LDNS_STATUS_DNSSEC_NSEC_RR_NOT_COVERED,
	LDNS_STATUS_DNSSEC_NSEC_WILDCARD_NOT_COVERED,
#ifdef LDNS_BUILD_CONFIG_USE_NSEC4
	LDNS_STATUS_DNSSEC_NSEC4_CHAIN_FAILED,
	LDNS_STATUS_DNSSEC_NSEC4_WILDCARD_BIT_UNSET,
	LDNS_STATUS_DNSSEC_NSEC4_ORIGINAL_NOT_FOUND,
#endif
