...
/*
	...
	ldns_rdf *wildcard_ancestor_name;
	ldns_rdf *hashed_wildcard_ancestor_name;
	
	bool nsec3_closest_encloser_proven = false;
	bool nsec3_wildcard_proven = false;
	bool nsec3_exact_name = false;
	bool nsec3_wildcard_ancestor_proven = false;
*/
